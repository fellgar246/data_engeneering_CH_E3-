...
BC_dag = DAG(
    dag_id='RickMorty_ETL',
    default_args=default_args,
    description='Agrega data de Rick and Morty de forma diaria',
...
def cargar_data(exec_date):
    ...
    for index, row in records.iterrows():
        cur.execute("INSERT INTO data_mining_RM ( index, id, name, status, species, gender, image, timestamp) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", (row['index'],row['id'], row['name'], row['status'], row['species'], row['gender'], row['image'], row['timestamp']))
